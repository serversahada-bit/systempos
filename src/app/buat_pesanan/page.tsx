            ...
            <div className="overflow-y-auto p-4 flex-1">
                    ...
                    <div key={b.id} className="border border-slate-200 rounded-xl p-3 flex gap-3 hover:border-purple-300 hover:shadow-md transition-all group bg-white cursor-pointer"
                      ...
                      <div className="flex items-center justify-center ml-2">
                        {added ? (
                          ...
                          <div className="w-8 h-8 rounded-full bg-fuchsia-100 text-fuchsia-600 group-hover:bg-fuchsia-600 group-hover:text-white transition-colors flex items-center justify-center">
              ...
              {filteredBundlings.length === 0 && (
                <div className="text-center py-10">
                  ...
                  <p className="text-slate-500 font-medium text-sm">Bundling tidak ditemukan.</p>
                </div>
              )}
            </div>
          </div>
